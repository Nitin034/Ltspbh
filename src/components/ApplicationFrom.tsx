      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Ayushi" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Enter Student class</Label>
            <Input id="class" placeholder="LKG , UKG 1 etc.." type="text" />
          </LabelInputContainer>
        </div>
          <LabelInputContainer>
            <Label htmlFor="lastname">Enter Father Name</Label>
            <Input id="Fathername" placeholder="Ayush" type="text" />
          </LabelInputContainer>
        ...
        <Label htmlFor="number">Enter Mobile Number</Label>
          <Input id="number" placeholder="Mobile Number" type="number" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
