   ...
   return (
     <div className=' max-w-[85rem] mx-auto px-8'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mx-auto">
        <div className="text-black h-full px-5">
        ...
        />
          ...
          <h1 className="text-black text-xl p-3 font-semibold drop-shadow-md font-dancing">Shivani Mishra</h1>
       <TextGenerateEffect words={words}/>
        ...
        /> 
          ...
          <h1 className="text-black text-xl p-3 font-semibold drop-shadow-md font-dancing">Ayush Mishra</h1>
